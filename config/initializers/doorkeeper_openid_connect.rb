...
Doorkeeper::OpenidConnect.configure do
  ...
  claims do
    ...
    # normal_claim :given_name, scope: :openid do |resource_owner, _scopes, _access_token|
    ...
    # normal_claim :family_name, scope: :openid do |resource_owner, _scopes, _access_token|
    #   resource_owner.family_name
    # end
    ...
    # normal_claim :middle_name, scope: :openid do |resource_owner, _scopes, _access_token|
    #   resource_owner.middle_name
    # end
    ...
    # normal_claim :nickname, scope: :openid do |resource_owner, _scopes, _access_token|
    ...
    # normal_claim :profile, scope: :openid do |resource_owner, _scopes, _access_token|
    ...
    # normal_claim :picture, scope: :openid do |resource_owner, _scopes, _access_token|
    ...
    # normal_claim :website, scope: :openid do |resource_owner, _scopes, _access_token|
    #   resource_owner.website
    # end
    ...
    normal_claim :email, scope: :openid do |resource_owner, _scopes, _access_token|
    ...
    # operating.
    normal_claim :email_verified, scope: :openid do |resource_owner, _scopes, _access_token|
    ...
    # normal_claim :gender, scope: :openid do |resource_owner, _scopes, _access_token|
    #   resource_owner.gender
    # end
    ...
    # normal_claim :birthdate, scope: :openid do |resource_owner, _scopes, _access_token|
    #   resource_owner.birthdate
    # end
    ...
    # normal_claim :zoneinfo, scope: :openid do |resource_owner, _scopes, _access_token|
    #   resource_owner.zoneinfo
    # end
    ...
    # normal_claim :locale, scope: :openid do |resource_owner, _scopes, _access_token|
    #   resource_owner.locale
    # end
    ...
    # normal_claim :phone_number, scope: :openid do |resource_owner, _scopes, _access_token|
    #   resource_owner.phone_number
    # end
    ...
    # RFC 3966 format.
    # normal_claim :phone_number_verified, scope: :openid do |resource_owner, _scopes, _access_token|
    #   resource_owner.phone_number_verified
    # end
    ...
    # normal_claim :address, scope: :openid do |resource_owner, _scopes, _access_token|
    ...
    normal_claim :updated_at, scope: :openid do |resource_owner, _scopes, _access_token|
