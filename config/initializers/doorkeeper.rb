...
Doorkeeper.configure do
  ...
  #
  grant_flows %w[client_credentials authorization_code password implicit_oidc]
...
Doorkeeper::JWT.configure do
  ...
  # Defaults to "secret"
  secret_key ENV['JWT_ENCRYPTION_TOKEN'] || raise('JWT_ENCRYPTION_TOKEN is missing. Please add it to your environment')
